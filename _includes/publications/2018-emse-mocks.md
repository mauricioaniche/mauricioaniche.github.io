* **[Mock objects for testing java systems: Why and how developers use them, and how they evolve](https://pure.tudelft.nl/portal/en/publications/mock-objects-for-testing-java-systems-why-and-how-developers-use-them-and-how-they-evolve(a653e382-3be1-465a-84e3-5415a7967464)/export.html)**<br>
  <span class="authors">Davide Spadini, Maurício Aniche, Magiel Bruntink, Alberto Bacchelli</span><br>
  <span class="conference">Empirical Software Engineering Journal, 2018.</span><br>
